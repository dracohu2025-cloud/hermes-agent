...
:::warning Windows
**不支持**原生 Windows。请安装 [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install) 并在其中运行 Hermes Agent。上述安装命令在 WSL2 内有效。
:::
...
<details>
<summary><strong>可选额外功能细分</strong></summary>
