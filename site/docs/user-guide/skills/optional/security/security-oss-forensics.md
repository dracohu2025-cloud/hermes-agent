...
## ⚠️ 反幻觉护栏 {#anti-hallucination-guardrails}
...
**参考**：详见 [recovery-techniques.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/security/oss-forensics/references/recovery-techniques.md)，了解如何获取强制推送的提交。
...
**参考**：详见 [evidence-types.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/security/oss-forensics/references/evidence-types.md)，了解 GH 事件类型。
...
- [investigation-templates.md](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/security/oss-forensics/references/investigation-templates.md) — 每种攻击类型的预构建假设模板
