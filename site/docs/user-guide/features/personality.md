...
# 个性与 SOUL.md {#personality-soul-md}
...
## SOUL.md 现在如何工作 {#how-soul-md-works-now}
...
## SOUL.md 里应该放什么？ {#what-should-go-in-soul-md}
...
## 好的 SOUL.md 内容 {#good-soul-md-content}
...
## Hermes 向提示词中注入什么 {#what-hermes-injects-into-the-prompt}
...
## SOUL.md 与 AGENTS.md {#soul-md-vs-agents-md}
...
## SOUL.md 与 `/personality` {#soul-md-vs-personality}
...
## 使用命令切换个性 {#switching-personalities-with-commands}
...
## 在配置中定义自定义个性 {#custom-personalities-in-config}
...
## 个性如何与完整提示词交互 {#how-personality-interacts-with-the-full-prompt}
...
## CLI 外观与会话个性 {#cli-appearance-vs-conversational-personality}
