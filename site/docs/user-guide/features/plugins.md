...
插件可以为这些生命周期事件注册回调。查看 **[事件钩子页面](/docs/user-guide/features/hooks#plugin-hooks)** 获取完整详情、回调签名和示例。
...
查看 **[完整指南](/docs/guides/build-a-hermes-plugin)** 了解处理器约定、模式格式、钩子行为、错误处理和常见错误。
