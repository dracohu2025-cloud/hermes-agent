...
## MCP 能为你带来什么 {#what-mcp-gives-you}
...
## 两种 MCP 服务器 {#two-kinds-of-mcp-servers}
...
## 针对每个服务器的过滤 {#per-server-filtering}
...
### 同时过滤实用工具 {#filter-utility-tools-too}
...
## 如果所有内容都被过滤掉了会怎样？ {#what-happens-if-everything-is-filtered-out}
...
### 具有最小 Issue 管理界面的 GitHub 服务器 {#github-server-with-a-minimal-issue-management-surface}
...
### 针对单个项目根目录的文件系统服务器 {#filesystem-server-for-a-single-project-root}
...
### 为什么 resource 或 prompt 工具没有出现？ {#why-didn-t-resource-or-prompt-utilities-appear}
...
## MCP Sampling 支持 {#mcp-sampling-support}
