...
<a id="unofficial-api-ban-risk"></a>
...
<a id="whatsapp-web-protocol-updates"></a>
---
...
## 步骤 1: 运行设置向导 {#step-1-run-the-setup-wizard}
...
## 步骤 2: 获取第二个电话号码（机器人模式） {#step-2-getting-a-second-phone-number-bot-mode}
...
## 消息格式与发送 {#message-formatting-delivery}
...
### WhatsApp 兼容的 Markdown {#whatsapp-compatible-markdown}
