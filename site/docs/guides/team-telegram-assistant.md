...
## 第 1 步：创建一个 Telegram 机器人 {#step-1-create-a-telegram-bot}
...
## 第 2 步：配置网关 {#step-2-configure-the-gateway}
...
## 第 3 步：启动网关 {#step-3-start-the-gateway}
...
## 第 4 步：设置团队访问权限 {#step-4-set-up-team-access}
...
### 方法 B：私聊配对（推荐团队使用） {#approach-b-dm-pairing-recommended-for-teams}
...
### 设置主频道（Home Channel） {#set-a-home-channel}
...
### 配置工具进度显示 {#configure-tool-progress-display}
...
### 使用 SOUL.md 设置性格 {#set-up-a-personality-with-soul-md}
...
### 使用 Docker 确保安全 {#use-docker-for-safety}
...
### 监控 Gateway {#monitor-the-gateway}
